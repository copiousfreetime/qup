      ...
      module Thrift
        module Kestrel
          ...
          class Get_result
            ...
            FIELDS = {
              SUCCESS => {:type => ::Thrift::Types::LIST, :name => 'success', :element => {:type => ::Thrift::Types::STRUCT, :class => Qup::Adapter::Kestrel::Thrift::Item}}
            }
          ...
          class Peek_result
            ...
            FIELDS = {
              SUCCESS => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => Qup::Adapter::Kestrel::Thrift::QueueInfo}
            }
