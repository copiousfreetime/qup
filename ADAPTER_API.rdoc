...
Classes/Modules to implement the rest of the beheavior.
...
worker queues. You should create a 'Qup::Adapter::MyBackend'include Qup:QueueAPI'. These are the methods that are
